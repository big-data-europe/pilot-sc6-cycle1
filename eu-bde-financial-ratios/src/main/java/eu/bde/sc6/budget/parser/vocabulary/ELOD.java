...
public class ELOD {
    ...
    public static final URI AGGREGATE = new URIImpl(NAMESPACE.concat("Aggregate"));
    ...
    public static final URI HAS_AGGREGATE = new URIImpl(NAMESPACE.concat("hasAggregate"));        
    public static final URI IS_STATISTIC_OF = new URIImpl(NAMESPACE.concat("isStatisticOf"));        
    public static final URI LAST_UPDATE_DATE = new URIImpl(NAMESPACE.concat("lastUpdateDate"));        
    public static final URI REFERENCE_TIME = new URIImpl(NAMESPACE.concat("referenceTime"));        
    public static final URI REFERENCE_TIME_DURATION = new URIImpl(NAMESPACE.concat("referenceTimeDuration"));        
    public static final URI HAS_VALUE = new URIImpl(NAMESPACE.concat("hasValue"));        
    public static final URI HAS_VALUE_PERCENTAGE = new URIImpl(NAMESPACE.concat("hasValuePercentage"));
}
