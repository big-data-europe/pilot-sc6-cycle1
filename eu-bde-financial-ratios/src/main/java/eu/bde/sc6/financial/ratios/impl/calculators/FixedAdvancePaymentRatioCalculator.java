 ...
 */
public class FixedAdvancePaymentRatioCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public FixedAdvancePaymentRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
    ...
    protected URI getTotalFinancialRatio() {
        return new URIImpl("http://bde.poolparty.biz/hierarchicalKAE/662");
    }
}
