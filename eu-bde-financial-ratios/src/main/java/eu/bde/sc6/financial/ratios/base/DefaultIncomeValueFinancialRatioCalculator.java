 ...
 */
public class DefaultIncomeValueFinancialRatioCalculator extends DefaultIncomeFinancialCalculatorBase {

    public DefaultIncomeValueFinancialRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
