 ...
 */
public class EmploymentCostsToRegularRevenuesRatioCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public EmploymentCostsToRegularRevenuesRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
