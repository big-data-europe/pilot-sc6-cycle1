 ...
 */
public abstract class DefaultIncomeFinancialCalculatorBase extends FinancialRatioCalculatorBase {
    ...
    public DefaultIncomeFinancialCalculatorBase(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
