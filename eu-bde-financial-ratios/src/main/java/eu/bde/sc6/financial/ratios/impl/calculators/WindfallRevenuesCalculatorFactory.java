 ...
 */
public class WindfallRevenuesCalculatorFactory extends FinancialRatioCalculatorFactoryBase{
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/faa16c86a904a954ad619551fbc091ee");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new WindfallRevenuesCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
