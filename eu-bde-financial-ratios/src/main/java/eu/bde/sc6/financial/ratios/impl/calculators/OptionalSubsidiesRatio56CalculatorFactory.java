 ...
 */
public class OptionalSubsidiesRatio56CalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/80c759da35747aef8df58801c2667cfd");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new OptionalSubsidiesRatio56Calculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
