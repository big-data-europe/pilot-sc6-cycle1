 ...
 */
public class WindfallRevenuesRatio_RegularlyOccurringCalculatorFactory extends FinancialRatioCalculatorFactoryBase {

    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/1af677a088a3157dc997c04a933182a8");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new WindfallRevenuesRatio_RegularlyOccurringCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
