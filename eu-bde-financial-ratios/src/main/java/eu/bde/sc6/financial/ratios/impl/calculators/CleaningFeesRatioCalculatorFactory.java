 ...
 */
public class CleaningFeesRatioCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/38d0bd81e5b7ce8502102b837678a590");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new CleaningFeesRatioCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
