 ...
 */
public class OtherDeductionsForThirdPartiesToYieldCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public OtherDeductionsForThirdPartiesToYieldCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
    ...
    protected URI getTotalFinancialRatio() {
        return new URIImpl("http://bde.poolparty.biz/hierarchicalKAE/661");
    }
}
