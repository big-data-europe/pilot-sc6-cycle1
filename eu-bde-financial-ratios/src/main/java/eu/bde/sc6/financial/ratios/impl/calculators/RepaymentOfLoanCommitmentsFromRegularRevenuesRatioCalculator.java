 ...
 */
public class RepaymentOfLoanCommitmentsFromRegularRevenuesRatioCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public RepaymentOfLoanCommitmentsFromRegularRevenuesRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
