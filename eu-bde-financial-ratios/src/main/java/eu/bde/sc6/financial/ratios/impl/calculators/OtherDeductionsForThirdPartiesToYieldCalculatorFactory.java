 ...
 */
public class OtherDeductionsForThirdPartiesToYieldCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/30201d5b283b767c29bdd9954f727402");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new OtherDeductionsForThirdPartiesToYieldCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
