 ...
 */
public class InsuranceContributionsToYieldRatioCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public InsuranceContributionsToYieldRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
    ...
    protected URI getTotalFinancialRatio() {
        return new URIImpl("http://bde.poolparty.biz/hierarchicalKAE/660");
    }
}
