 ...
 */
public class FiscalYearsExpensesCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/da6d0838c928622accc405a90d1f3ea2");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new FiscalYearsExpensesCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
