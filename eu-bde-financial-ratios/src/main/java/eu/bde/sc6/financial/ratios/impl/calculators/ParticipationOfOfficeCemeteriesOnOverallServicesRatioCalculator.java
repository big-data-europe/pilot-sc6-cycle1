 ...
 */
public class ParticipationOfOfficeCemeteriesOnOverallServicesRatioCalculator extends ArithmeticFinancialRatioCalculatorBase {
    String QUERY_ARITHM = ""
            + "SELECT * "
            + "FROM <<dataGraph>>  "
            + "WHERE {"
            ...
            + "         ) "
            + "         FILTER(STRSTARTS(STR(?kaeuri), \"http://linkedeconomy.org/resource/KAE/<year>/Income/4/45\"))"            
            + "     }"
            + " }"
            + " {"
    ...
    public ParticipationOfOfficeCemeteriesOnOverallServicesRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
