 ...
 */
public class TaxesAndOtherChargesToYieldRatioCalculator extends DefaultExpensePercentageFinancialRatioCalculator {
    ...
    public TaxesAndOtherChargesToYieldRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
    ...
    protected URI getTotalFinancialRatio() {
        return new URIImpl("http://bde.poolparty.biz/hierarchicalKAE/9");
    }
}
