 ...
 */
public class ParticipationOfConstructionServiceOnOverallServicesRatioCalculator extends ArithmeticFinancialRatioCalculatorBase {
    ...
    String QUERY_ARITHM = ""
            ...
            + "         ) "
            + "         FILTER(STRSTARTS(STR(?kaeuri), \"http://linkedeconomy.org/resource/KAE/<year>/Income/3/30\"))"            
            + "     }"
            + " }"
            + " {"
    ...
    public ParticipationOfConstructionServiceOnOverallServicesRatioCalculator(URI financialRatio, SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
