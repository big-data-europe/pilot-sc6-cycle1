 ...
 */
public class TaktikaCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new TaktikaCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
