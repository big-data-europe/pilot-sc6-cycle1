 ...
 */
public class ReservesRatioCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new ReservesRatioCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
