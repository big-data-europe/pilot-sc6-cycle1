 ...
 */
public class CashBalanceToTotalRevenuesRatioCalculatorFactory extends FinancialRatioCalculatorFactoryBase{
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/d337a378cc8f20c66d7f412f2db9fe5e");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new CashBalanceToTotalRevenuesRatioCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
