 ...
 */
public class FixedAdvancePaymentRatioCalculatorFactory extends FinancialRatioCalculatorFactoryBase{
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/2fd972f9b73bd2b483dc4ed3acd360c8");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new FixedAdvancePaymentRatioCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
