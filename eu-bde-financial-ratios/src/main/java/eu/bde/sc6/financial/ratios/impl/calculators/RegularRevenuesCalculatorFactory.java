 ...
 */
public class RegularRevenuesCalculatorFactory extends FinancialRatioCalculatorFactoryBase {
    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/5d86d0b8e9beee2dcc39e8c6dd8500c6");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new RegularRevenuesCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
