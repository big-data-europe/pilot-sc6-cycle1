 ...
 */
public class TotalRevenuesCalculatorFactory extends FinancialRatioCalculatorFactoryBase {

    private final URI FINANCIAL_RATIO = new URIImpl("https://bde.poolparty.biz/SC6-Financial-Ratios/1350d123e498e9924b7127cb98c74bca");
    ...
    public FinancialRatioCalculator get(SPARQLRepository dataRepository, SPARQLRepository pptRepository) {
        if(instance==null){
            instance = new TotalRevenuesCalculator(FINANCIAL_RATIO, dataRepository, pptRepository);
        }
        return instance;
    }
